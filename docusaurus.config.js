...
const mintMapVersion = dependencies['@mint-ui/core'];
...
const config = {
  title: `Guide for @mint-ui/core ${mintMapVersion}`,
  tagline: 'The React library for headless UI',
  ...
  baseUrl: '/mint-ui-core-guide/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'dev-rsquare', // Usually your GitHub org/user name.
  projectName: 'mint-ui-core-guide', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://www.npmjs.com/package/@mint-ui/core',
            label: 'npm',
            position: 'right',
          },
